...
Placeholder workspace for future artwork design systems, creative briefs,
style references, generated image sets, review notes, and asset handoff.
Keep design sources, screenshots, and exports inside this project folder.
