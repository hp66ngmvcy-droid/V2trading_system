...
Placeholder workspace for future graphics helper tools, asset cleanup,
thumbnail generation, layout support, image review, and reusable visual
workflows. Keep generated assets and screenshots inside this project folder.
