...
- `docs/projects/idea-orchestrator-system/assets/IDEA_TEMPLATE.md` - copy this for each idea.
...
- `docs/projects/idea-orchestrator-system/03_delivery/SESSION_MEMORY.md` - approved idea progress log.
...
```bash
cp docs/projects/idea-orchestrator-system/assets/IDEA_TEMPLATE.md ideas/inbox/idea_2026-05-14_my-idea.md
```
...
At about 4:15 AM, daemon mode processes approved ideas, updates `CLAUDE.md` and `docs/projects/idea-orchestrator-system/03_delivery/SESSION_MEMORY.md`, moves approved ideas to `ideas/implemented`, and commits only orchestrator-managed files unless started with `--no-commit`.
